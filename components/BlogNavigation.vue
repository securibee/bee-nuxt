    ...
    <div class="container mx-auto flex items-center">
      <div class="flex w-1/2 pl-4 text-sm">
        <ul class="list-reset flex">
          <li v-for="(link, index) in links" :key="index" class="mr-2">
            <nuxt-link
              class="border-t-4 border-transparent inline-block font-bold text-lg text-black no-underline hover:border-black pb-2 px-2"
              :to="`/${link.slug}`"
              >{{ link.title }}
            </nuxt-link>
          </li>
